...
public class DealerWinningByCardsValueStrategy implements ShuffleStrategy {
    ...
    public List<Card> shuffle(List<Card> cards) {
        ...
        cards.removeIf(card -> card.cardNumber().equals(EIGHT) && card.suit().equals(HEARTS));
        ...
        cards.add(2, new Card(EIGHT, HEARTS));
