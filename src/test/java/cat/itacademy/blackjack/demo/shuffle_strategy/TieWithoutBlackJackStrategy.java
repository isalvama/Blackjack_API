...
public class TieWithoutBlackJackStrategy implements ShuffleStrategy {
    ...
    public List<Card> shuffle(List<Card> cards) {
        ...
        cards.removeIf(card -> card.cardNumber().equals(EIGHT) && card.suit().equals(SPADES));

        cards.add(0, new Card(JACK, SPADES));
        cards.add(1, new Card(NINE, CLUBS));
        cards.add(2, new Card(NINE, HEARTS));
        cards.add(3, new Card(EIGHT, SPADES));
        return cards;
    }
}
